...
exports.metadata = void 0; // app/layout.tsx

var link_1 = Promise.resolve().then(function () {
  return _interopRequireWildcard(import("next/link"));
});
Promise.resolve().then(function () {
  return _interopRequireWildcard(import("./globals.css"));
});
exports.metadata = {
  title: "Repo Board",
...
function Header() {
  ...
  }, "Projects")), React.createElement("nav", {
...
function Footer() {
  return React.createElement("footer", {
    className: "mt-16 border-t border-base-border pt-6 text-center text-xs text-base-sub"
